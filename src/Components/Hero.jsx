  ...
  return (
    <div className='bg-secondary text-white  py-10'>
        <div className='container py-3 grid col-span-1 md:grid-cols-2 items-center justify-between gap-2'>
            <div className='flex flex-col items-center md:items-start gap-8 justify-center order-2 md:order-1'>
            ...
            <div className="gird items-center relative justify-center order-1 md:order-2">
                <img src={image} className='w-[300px] sm:scale-110 md:scale-125 lg:scale-150 md:w-[450px] spin mx-auto' alt="" />
                <button className='absolute top-3 left-4 bg-gradient-to-r from-primary to-secondary/80 bg-primary px-4 py-3 border-none rounded-md'>Hey Coder</button>
                <button className='absolute bottom-3 right-4 bg-gradient-to-r from-primary to-secondary/80 bg-primary px-4 py-3 border-none rounded-md'>Best Coffee</button>
            </div>
        </div>
    </div>
  )
