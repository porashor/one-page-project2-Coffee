...
const Service = () => {
  ...
  return (
    <div className='container py-10'>
      <h1 className='text-2xl md:text-4xl font-bold capitalize font-cursive text-center text-slate-900'>Best coffee for you </h1>
      <div className='flex items-center justify-evenly gap-8 pt-[100px]'>
        {
            ServicesData.map((item, index)=>(
                <div className='min-h-[200px] rounded-lg min-w-[300px] relative hover:bg-primary shadow-2xl transition-all duration-200 group py-4' key={index}>
